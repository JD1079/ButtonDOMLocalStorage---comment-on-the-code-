 const clickCountDisplay = document.getElementById('click-count'); 
       ...
       //this is putting all the variables for the other files into this file by calling the name of the variable 
...
//This is updating the score of the button clikc every time the button is clicked
//3.Explain what function updateUI does and is holding the colors and texts
  ...
  //This is changing the background color and text of the body and button everytime a certin condition is met
